function setFlagPropertiesFromArray(waterUtil, propArray)
...
waterUtil.IsBaseLoad = logical(propArray(2));

% 3) IsIrrigation
% Convert to logical (0 = false, any other value is true)
waterUtil.IsIrrigation = logical(propArray(3));

% 4) IsCoolingTower
% Convert to logical (0 = false, any other value is true)
waterUtil.IsCoolingTower = logical(propArray(4));
