classdef Water < ece.Utility
    ...
    properties (Access = public, AbortSet, SetObservable)
        ...
        % cooling tower water. Column vector.
        SummerWaterDist (12,1) double = ...
            [0.0 0.0 0.0 0.0 0.03 0.14 0.3 0.3 0.2 0.03 0.0 0.0]';
    ...
    methods
        ...
        function obj = Water()
            ...
            % -- Initial Settings
            % Set Default Water Name
            obj.Name = "Default Water Utility";
