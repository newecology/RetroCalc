...
importedBuildings = ece.Building.fromBuildingExcelFile(dataSource);

%% Add Buildings to Site
% Use add method to bring in Buildings with flow-down properties set.
site.addBuildings(importedBuildings);
