...
% Extract Table and retain only rows that are not "None";
plumbFixtureTbl = readtable(fileName,opts);
plumbFixtureTbl = plumbFixtureTbl(...
    ~strcmp(plumbFixtureTbl.FixtureType,"None"),:);

% Replace NaN values with 0.
plumbFixtureTbl = fillmissing(plumbFixtureTbl,...
    "constant", 0,...
