classdef OpaqueSurface < handle & matlab.mixin.Copyable
    ...
    properties (Access = public)
        ...
        % Name: String name for labeling an instance of this object.
        %  i.e., "South Wall".
        Name (1,1) string = "Default Opaque Surface";
        ...
        OpaqueSurfaceType (1,1) ece.enum.OpaqueSurfaceType = ...
            ece.enum.OpaqueSurfaceType.Wall;
        ...
        ShadingMonthly (12,1) double = zeros(12,1);
    ...
    properties (Access = public, Dependent)
        ...
        % ShadingTable: Table of ShadingMonthly values set across the
        % months of the year.
        ShadingTable (12,2) table
    ...
    methods
        ...
        function value = get.ShadingTable(obj)
            % Getter for ShadingTable.
            %   For UI purposes, this property returns the ShadingMonthly
            %   array of 12 values as a table with two columns - the first
            %   being the Month string and the second being the data vector
            %   of ShadingMonthly.

            % Create Month Name String Column Vector
            monthTimes = datetime(2000,1:12,1);
            monthNames = string(month(monthTimes,"name"))';

            % Create Month Table
            value = table(monthNames,obj.ShadingMonthly,...
                'VariableNames',["Month","ShadingProportion"]);

        end %function (ShadingTable)
