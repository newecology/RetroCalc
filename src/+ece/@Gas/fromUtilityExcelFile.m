function gasUtilities = fromUtilityExcelFile(excelFilePath)
...
if (numGasSheets == 0)
    ...
    gasUtilities = ece.Gas.empty(0,1);
    return;
end %endif
...
gasUtilities = ece.Gas.empty(numGasSheets,0);
...
for sheetIdx = 1:numGasSheets
    ...
    gasUtil.setFlagPropertiesFromArray(propArray);   
