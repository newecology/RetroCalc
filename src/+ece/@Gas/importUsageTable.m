function importUsageTable(gasUtil,useTbl)
...
gasUtil.RawUsageTable = rmmissing(useTbl, 'DataVariables', useTbl.Properties.VariableNames);

% The AdjustedUsageTable will be further cleaned and sanitized as it is processed
% going forward.
gasUtil.AdjustedUsageTable = rmmissing(useTbl, 'DataVariables', useTbl.Properties.VariableNames);
