...
% Site to contain the calculations for Ventilation and Fan 
    properties
        ...
        AverageSpeed (1,2) double {mustBeInRange(AverageSpeed, 0, 1)} = [0,0];
        ...
        CalcMethod (1,1) ece.enum.CalculationMethod = ...
            ece.enum.CalculationMethod.ComputeMotorPower;

        % TotalStaticPressure_inch - Total static pressure on the fan in
        % inches of water gauge.
        TotalStaticPressure_inch (1,1) double = 0;

        % FanEfficiency - Fan efficiency.
        FanEfficiency (1,1) double = 0;

        % MotorEfficiency - Motor Efficiency
        MotorEfficiency (1,1) double = 0;
        ...
        % MotorPowerDraw.
        MotorPowerDraw_kW (1,1) double = 0;
        ...
        OperationMonths (1,2) double  = [1,12];%{mustBeInRange(OperationMonths, 1, 12)}   
