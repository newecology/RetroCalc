function plotTotalOilUsage(obj, ax, showAccumulation)
% plotTotalOilUsage: Method to plot the monthly Oil usage for a 
% Building.
%   This method pulls the Oil usage for the building as derived from the
...
if showAccumulation
    plotAccumulatedUsage = plot(ax,timeDomain,...
        ...
        "Marker",".",...
        "MarkerSize",markerSize,...
        "DisplayName","Accumulated Monthly Oil Usage");
end %endif
