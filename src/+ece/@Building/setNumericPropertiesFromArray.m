...
% 1-3) Building Area Properties
% Place all area inputs into independent properties.
b.GrossArea_ft2 = propArray(1);
b.GrossConditionedArea_ft2 = propArray(2);
b.IntConditionedArea_ft2 = propArray(3);

% 4) CoolingAreaPercent
% Set double value directly.
b.PercentCondAreaCooled = propArray(4);

% 5) NumberOfUnits
% MW_MISU: Will this need to be pulled out and become a dependent
% property on the NumberOfBedroomUnits?
b.NumberOfUnits = propArray(5);

% 6-9) NumberOfBedroomsUnits
% Place all bedrooms/units counts into single 1x4 array.
b.NumberOfBedroomUnits = propArray(6:9);

% 10) NumberOfOccupants
b.NumberOfOccupants = propArray(10);

% 11) NumberOfStories
b.NumberOfStories = propArray(11);

% 12) YearOfConstruction
b.YearOfConstruction = propArray(12);
