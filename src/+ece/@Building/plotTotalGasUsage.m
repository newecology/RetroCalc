function plotTotalGasUsage(obj, ax, showAccumulation)
% plotTotalGasUsage: Method to plot the monthly Gas usage for a Building.
%   This method pulls the Gas usage for the building as derived from the
...
totalUsage = obj.MonthlyGasProfile.Total;
...
if showAccumulation
    plotAccumulatedUsage = plot(ax,timeDomain,...
        ...
        "Marker",".",...
        "MarkerSize",markerSize,...
        "DisplayName","Accumulated Monthly Gas Usage");
end %endif
...
% data.
% -- Axes Labels
title(ax,"Building Total Monthly Gas Usage");
xlabel(ax,"Month");
