...
numBedrms = sum(obj.NumberOfBedroomUnits .* [1 2 3 4]);
...
for n = 1:numApplTypes
    ...
    annlTherms = 0; 
    annlkWh = 0;
    loadsWeekApartment = 0; 
    machineEnergyLoad_kWh = 0; 
    refrigeratorAnnual_kWh = 0; 
    annlElectricity_kWh = 0;
    ...
    if ismember(obj.Appliances(n).ApplianceCategory,["Stove","Dryer"])
    ...
    % fixtures class
    if ismember(obj.Appliances(n).ApplianceCategory,["Dishwasher","Clotheswasher"])
...
% MW_MISU: These preallocations are not used.
