function plotTotalBaseloadUsage(obj, ax, showAccumulation)
% plotTotalBaseloadUsage: Method to plot the monthly Baseload usage for a 
% Building.
%   This method pulls the Baseload usage for the building as derived from the
...
plotUsage = plot(ax,timeDomain,...
    ...
    "DisplayName","Monthly Baseload Usage");
...
if showAccumulation
    plotAccumulatedUsage = plot(ax,timeDomain,...
        ...
        "Marker",".",...
        "MarkerSize",markerSize,...
        "DisplayName","Accumulated Monthly Baseload Usage");
end %endif
...
% data.
% -- Axes Labels
title(ax,"Building Total Monthly Baseload Usage");
xlabel(ax,"Month");
ylabel(ax,"Usage (kWh");
