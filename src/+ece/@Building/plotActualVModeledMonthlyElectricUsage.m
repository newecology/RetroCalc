function plotActualVModeledMonthlyElectricUsage(obj, ax)
% plotActualVModeledMonthlyElectricUsage: Method to plot the actual
% vs. Modeled monthly usage of Electric for a single year.
...
modeledUsage = obj.BuildingEnergyUsageTable.Electricity_kWh(1:12);
...
% -- Axes Labels
title(ax,"Actual vs. Modelled Monthly Electricity Usage");
xlabel(ax,"Month");
