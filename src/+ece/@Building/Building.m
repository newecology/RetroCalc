    ...
    methods 
        ...
        function value = get.CanUndergoHEA(obj)
            ...
            value = ~isempty(obj.AnnualElectricUsageTable) && ...
                ...
                ~isempty(obj.AnnualOilUsageTable) && ...
                ~isempty(obj.AnnualPropaneUsageTable) && ...
                ~isempty(obj.MonthlyElectricProfile) && ...
                ~isempty(obj.MonthlyGasProfile) && ...
                ~isempty(obj.MonthlyWaterProfile) && ...
                ~isempty(obj.MonthlyOilProfile) && ...
                ~isempty(obj.MonthlyPropaneProfile);
