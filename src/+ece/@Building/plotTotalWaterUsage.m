function plotTotalWaterUsage(obj, ax, showAccumulation)
% plotTotalWaterUsage: Method to plot the monthly Water usage for a 
% Building.
%   This method pulls the Water usage for the building as derived from the
...
totalUsage = obj.MonthlyWaterProfile.TotalGallons;
...
plotUsage = plot(ax,timeDomain,...
    ...
    "DisplayName","Monthly Water Usage");
...
if showAccumulation
    plotAccumulatedUsage = plot(ax,timeDomain,...
        ...
        "Marker",".",...
        "MarkerSize",markerSize,...
        "DisplayName","Accumulated Monthly Water Usage");
end %endif
