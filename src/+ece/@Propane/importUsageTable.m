...
%   corresponding Propnae object. The table will undergo sanitization and
%   validation checks first, such that the table finally assigned to the
%   AdjustedUsageTable property of the Propnae object is set for HEA (or other)
%   downstream calculations.

%% Arguments
% Ensure inputs are the correct size and type.
arguments
    % g: Self-referential Propnae object.
...
% This is done with the correctBilling.m method for the Propnae class.
propaneUtil.correctBilling();
