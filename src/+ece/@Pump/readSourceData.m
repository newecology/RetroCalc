...
% Extract Table and remove rows that have empy quantity or CalcMethod.
pumpTbl = readtable(fileName,opts);
pumpTbl = rmmissing(pumpTbl,...
    "DataVariables",["Quantity","CalcMethod"]);

% Replace NaN values with 0.
pumpTbl = fillmissing(pumpTbl,...
    "constant", 0,...
