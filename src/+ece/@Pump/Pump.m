classdef Pump < handle & matlab.mixin.Copyable
    ...
    properties (Access = public, SetObservable)
        ...
        % Flow_Gallons/ming - Fluid flow in Gallons Per Minute.
        Flow_gpm (1,1) double = 0;

        % TotalStaticPressure_inch - Total static pressure on the pump in
        % inches of water gauge.
        HeadPressure_feet (1,1) double = 0;

        % pumpEfficiency - pump efficiency.
        PumpEfficiency (1,1) double = 0;
        ...
        OperationMonths (1,2) double = [1,12];
