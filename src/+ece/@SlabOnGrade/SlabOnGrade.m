classdef SlabOnGrade < handle & matlab.mixin.Copyable
    ...
    properties (Access = public)
        ...
        Name (1,1) string = "Default Slab on Grade";

        %Perimeter of slab in feet
        Perimeter_ft (1,1) double = 0;
    ...
    methods   (Access = public, Static)
        ...
        % readSourceData - Method to generate an object from inputs file.
        slabArr = readSourceData(fileName);
