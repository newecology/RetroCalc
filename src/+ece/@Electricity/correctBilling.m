function correctBilling(elecUtil)
...
elecUtil.AdjustedUsageTable.AdjkWh = (elecUtil.AdjustedUsageTable.Usage ./ elecUtil.AdjustedUsageTable.Days) * (365/12);

% Compute the fractional adjustment needed to map sum of Adjusted kWh back
% to total real kWh.
fracAdj = sum(elecUtil.AdjustedUsageTable.AdjkWh) / sum(elecUtil.AdjustedUsageTable.Usage);

% Apply adjustment to AdjkWh to make the values the same.
elecUtil.AdjustedUsageTable.AdjkWh = elecUtil.AdjustedUsageTable.AdjkWh / fracAdj;
