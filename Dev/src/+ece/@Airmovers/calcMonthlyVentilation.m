...
function [HtngVentilationFlow, ClngVentilationFlow] = calcMonthlyVentilation(obj)
...
%make an array of the effective average cfm for calculating total balanced
%and unbalanced flows for times 1 and 2 and for heating/cooling
% array has a row for each ventilation object
%four columns for: 
% 1 effective avg cfm htg time1, 2 effective avg cfm htg time2, ...
% 3 effective avg cfm clg time1, 4 effective avg cfm clg time2
% sum each column to get a (1,4) vector
